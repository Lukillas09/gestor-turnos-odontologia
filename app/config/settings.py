...
TURNOS_PUBLIC_ACTION_TOKEN_SECONDS = int(env("TURNOS_PUBLIC_ACTION_TOKEN_SECONDS", "86400"))
TURNOS_PUBLIC_DNI_RATE_LIMIT_ATTEMPTS = int(env("TURNOS_PUBLIC_DNI_RATE_LIMIT_ATTEMPTS", "30"))
TURNOS_PUBLIC_DNI_RATE_LIMIT_SECONDS = int(env("TURNOS_PUBLIC_DNI_RATE_LIMIT_SECONDS", "600"))
